...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference("Pizza.count") do
      post pizzas_url, params: { pizza: { base_price: @pizza.base_price, displayed_price: @pizza.displayed_price, name: @pizza.name, size: @pizza.size } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { base_price: @pizza.base_price, displayed_price: @pizza.displayed_price, name: @pizza.name, size: @pizza.size } }
